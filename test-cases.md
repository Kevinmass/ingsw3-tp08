...
### TestCreate_Success
**Objetivo:** Crear usuario en base de datos real.  
**Escenario:** Email único, datos válidos.  
**Resultado esperado:** Usuario insertado, ID generado.

### TestCreate_DuplicateEmail
**Objetivo:** Prevenir email duplicado en BD.  
**Escenario:** Email ya existe.  
**Resultado esperado:** Error duplicado.

### TestFindByEmail_Exists
**Objetivo:** Encontrar usuario por email existente.  
**Escenario:** Email registrado.  
**Resultado esperado:** Usuario retornado.

### TestFindByEmail_NotExists
**Objetivo:** Manejar email no encontrado.  
**Escenario:** Email no registrado.  
**Resultado esperado:** Nil retornado.

### TestFindByID_Exists
**Objetivo:** Encontrar usuario por ID existente.  
**Escenario:** ID válido con usuario.  
**Resultado esperado:** Usuario retornado.

### TestFindByID_NotExists
**Objetivo:** Manejar ID no encontrado.  
